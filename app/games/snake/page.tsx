  ...
  const loadLeaderboard = async (showLoading = false) => {
    try {
      ...
      if (response.ok) {
        ...
        console.log("Leaderboard updated:", data.leaderboard?.length || 0, "entries")
      }
    } catch (error) {
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-4">
                <div className="px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-lg">
                  <span className="text-green-400 font-semibold">Player: {gameState.playerName}</span>
                </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {entry.walletAddress && (
                          <p className="text-gray-500 text-xs">{formatWalletAddress(entry.walletAddress)}</p>
                        )}
